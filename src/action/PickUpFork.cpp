...
void pickUpFork(const Eigen::Isometry3d &plate,
  ...
  moveInto(nullptr, TargetItem::FORQUE, endEffectorDirection, feedingDemo);
  ...
  moveOutOf(nullptr, // ignore collision
            TargetItem::FORQUE, length, direction, feedingDemo);
